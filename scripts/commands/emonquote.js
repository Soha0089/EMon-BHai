...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (input.length !== 2) {
    api.sendMessage('To use this command, simply type “MyQuote [text] = [author]”, where [text] is the quote you want to save and [author] is the name of the person who said it. For example, to save the quote "The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart" by Helen Keller, you would type “MyQuote The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart = Helen Keller.”', threadID, messageID);
    return;
  }
